...
public final class GeaWebConstants {
    ...
    public final static String MEDIDOR_ERROR_ELIMINAR = "medidor.error.eliminar";
    public final static String MEDIDOR_ERROR_CREAR = "medidor.error.crear";
    public final static String MEDIDOR_ERROR_ACTUALIZAR = "medidor.error.actualizar";

    public final static String MEDIDOR_SUCCESS_ELIMINAR = "medidor.success.eliminar";
    public final static String MEDIDOR_SUCCESS_CREAR = "medidor.success.crear";
    public final static String MEDIDOR_SUCCESS_ACTUALIZAR = "medidor.success.actualizar";
